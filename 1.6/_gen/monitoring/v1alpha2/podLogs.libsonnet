{
  ...
  '#spec':: d.obj(help='"PodLogsSpec defines how to collect logs for a Pod."'),
  spec: {
    ...
    '#relabelings':: d.obj(help='"RelabelConfigs to apply to logs before delivering."'),
    relabelings: {
